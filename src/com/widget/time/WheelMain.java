...
import com.nbmlm.housekeeping.R;
...
public class WheelMain {
	...
	private String[] mMins = new String[]{"0","30"};
	...
	public void initDateTimePicker(int year ,int month ,int day,int h,int m) {
		...
		if(hasSelectTime){
			...
			wv_mins.setAdapter(new ArrayWheelAdapter<String>(mMins));
	...
	public String getTime() {
		...
		if(!hasSelectTime)
			...
			.append(wv_mins.getCurrentItem()==1?"30":"00");
		return sb.toString();
	}
}
